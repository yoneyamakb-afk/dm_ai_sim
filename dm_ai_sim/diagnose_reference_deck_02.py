...
def main() -> None:
    ...
    if report["simulation_readiness"] == "Ready":
        ...
        print("provisional_risk: placeholder conversion would hide missing card text, costs, civilizations, lock/meta effects, alternate-win behavior, and card-specific mechanics")
